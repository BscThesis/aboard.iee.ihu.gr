<template>
    <div class="block">
        ...
        <div class="block" v-if="!loading">
            ...
            >
                <div class="field">
                    <div class="columns">
                        ...
                        <div
                            class="column"
                            v-bind:class="{ 'is-hidden': !other_user }"
                        >
                            <div class="field" v-if="other_user">
                                <label
                                    class="label is-capitalized is-unselectable"
                                >
                                    Συντάκτες
                                </label>
                                <div
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="dropdown-content dropdown-content-fixed"
                                        >
                                            <a
                                                class="dropdown-item"
                    ...
                    <div class="column">
                        ...
                        <div class="field is-grouped is-grouped-multiline">
                            <div
                                class="control"
                                v-for="(item,
                                index) in announcement.attachments"
                                v-bind:key="index"
                            >
                                <div class="tags has-addons">
                                    <a
                                        ...
                                        >{{ item.filename }}</a
                                    >
                                    <a v-else class="tag is-info is-light">{{
                                        item.name
                                    }}</a>
                                    <a
                                        class="tag is-delete"
            ...
            <div
                class="field"
                id="event-related-info"
                v-if="announcement.is_event"
            >
                <div class="field">
                    <label class="label is-capitalized is-unselectable">
                        Τοποθεσία εκδήλωσης
                ...
                <article class="message is-danger">
                    <div class="message-body">
                        <p class="subtitle is-6">
                            Η ανακοίνωση περιέχει δημόσιες ετικέτες
                        </p>
                    </div>
                </article>
            </div>
    ...
    methods: {
        ...
        addAnnouncement: function() {
            ...
            if (vm.announcement.attachments.length > 0) {
                let old_attachments = vm.announcement.attachments.filter(
                    function(attachment) {
                        return attachment.id;
                    }
                );

                let new_attachments = vm.announcement.attachments.filter(
                    function(attachment) {
                        return !attachment.id;
                    }
                );
                ...
                if (old_attachments.length > 0) {
                    formData.append(
                        "attachments_old",
                        JSON.stringify(old_attachments)
                    );
                }
            ...
            if (!vm.announcement.title) {
                vm.errors.push(
                    "Ο τίτλος της ανακοίνωσης δεν μπορεί να είναι κενός"
                );
            } else {
            ...
            if (
                ...
                vm.errors.push(
                    "Το κείμενο της ανακοίνωσης δεν μπορεί να είναι κενό"
                );
            } else {
            ...
            formData.append(
                "is_pinned",
                JSON.stringify(vm.announcement.is_pinned)
            );
            ...
            formData.append(
                "is_event",
                JSON.stringify(vm.announcement.is_event)
            );
            ...
            if (vm.announcement.is_event) {
                if (!vm.announcement.event_location) {
                    vm.errors.push(
                        "Ο τόπος της εκδήλωσης δεν μπορεί να είναι κενός"
                    );
                } else {
                    formData.append(
                        "event_location",
                        vm.announcement.event_location
                    );
                }
            ...
            if (vm.announcement.tags.length == 0) {
                vm.errors.push(
                    "Η ανακοίνωση πρέπει να έχει τουλάχιστον μία ετικέτα"
                );
            } else {
                ...
                axios
                    ...
                    .then(function(response) {
                        ...
                        window.location.replace(
                            "/announcements/" + response.data.data.id
                        );
                    })
                    .catch(function(error) {
                        vm.btnLoading = false;
