  ...
  <div class="block">
    ...
    <div class="block">
      ...
      <doc-item
        ...
        requestType="GET"
        description="Retrieves all annnouncements"
      ...
      <doc-item
        title="/api/events"
        requestType="GET"
        description="Retrieves public info about events"
      ...
      <doc-item
        title="/api/pinned"
        requestType="GET"
        description="Retrieves all pinned annnouncements that are still valid"
      ...
      <doc-item
        title="/api/search?q=['word1','word2']"
        requestType="GET"
        description="Retrieves all annnouncements based on search criteria"
    ...
    <div class="block">
      ...
      ></doc-item>
      <doc-item
        title="/api/auth/authors"
        requestType="GET"
        description="Retrieves list of authors"
...
export default {
  data: function() {
    return {
      ...
      eventsResponse: `{ "current_page": 1, "data": [ { "id": 1, "title": "Δοκιμαστική εκδήλωση", "event_location": "TEITHE", "gmaps": 1, "event_start_time": "2020-01-30 00:00:00", "event_end_time": "2020-01-31 00:00:00" } ], "first_page_url": "https://aboard.iee.ihu.gr/api/events?page=1", "from": 1, "last_page": 1, "last_page_url": "https://aboard.iee.ihu.gr/api/events?page=1", "next_page_url": null, "path": "https://aboard.iee.ihu.gr/api/events", "per_page": 12, "prev_page_url": null, "to": 1, "total": 1 }`,
      pinnedResponse: `[ { "id": 1, "title": "Δοκιμαστική εκδήλωση" } ]`,
      ...
      wordSearchRespose: `{"data":[{"id":5,"title":"\u0391\u03bd\u03b1\u03ba\u03bf\u03af\u03bd\u03c9\u03c3\u03b7","eng_title":null,"body":"<p>\u0394\u03b7\u03bc\u03cc\u03c3\u03b9\u03b1 \u03b1\u03bd\u03b1\u03ba\u03bf\u03af\u03bd\u03c9\u03c3\u03b7<\/p>","eng_body":null,"has_eng":0,"created_at":"2020-04-13 20:37","updated_at":"2020-04-17 18:57","is_pinned":0,"pinned_until":null,"is_event":1,"event_start_time":"2020-04-29 00:00","event_end_time":"2020-04-30 00:00","event_location":"\u0394\u0399\u03a0\u0391\u0395 \u03a3\u03af\u03bd\u03b4\u03bf\u03c2","gmaps":1,"tags":[{"id":19,"title":"\u0386\u03bb\u03bb\u03b1 \u03b4\u03b7\u03bc\u03cc\u03c3\u03b9\u03b1 \u03bd\u03ad\u03b1","parent_id":1,"is_public":1}],"attachments":[],"author":{"name":"Nikolaos Christos Nikolaidis","id":2}}],"links":{"first":"https:\/\/aboard.iee.ihu.gr\/api\/search?page=1","last":"https:\/\/aboard.iee.ihu.gr\/api\/search?page=1","prev":null,"next":null},"meta":{"current_page":1,"from":1,"last_page":1,"path":"https:\/\/aboard.iee.ihu.gr\/api\/search","per_page":10,"to":1,"total":1}}`,
      ...
      authAuthorsResponse: `[{"id":2,"name":"Nikolaos Christos Nikolaidis","email":"it113763@it.teithe.gr","created_at":"2020-04-10 13:32:24","updated_at":"2020-04-10 13:32:24","is_author":1,"is_admin":1}]`,
