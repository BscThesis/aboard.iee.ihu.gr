<template>
    <div class="block">
        ...
        <div class="block">
            <!-- Docs List -->
            <div class="block">
                <h3 class="subtitle is-3 has-text-centered">Attachments</h3>
            </div>
            <doc-item
                title="/api/announcements/{id}/attachments/{id}"
                requestType="GET"
                description="Retrieves the attachment with the id of {id} of the annnouncement with the id of {id}"
        ...
        <div class="block">
            <div class="block">
                ...
                <h5 class="subtitle is-5 has-text-centered">
                    Aboard uses OAuth2.0 for login implementation. In order to
                    login you need to get the token from login.iee.ihu.gr. Then
            ...
            ></doc-item>
            <doc-item
                title="/api/auth/user/notifications/read"
                requestType="GET"
                description="Reads all notifications and retrieves user's notifications"
                :response="userNotificationsResponse"
                auth
            ></doc-item>
            <doc-item
            ...
            ></doc-item>
            <doc-item
                title="/api/auth/subscriptions"
                requestType="GET"
                description="Retrieves user's subscriptions"
        ...
        <div class="block">
            ...
            <div class="box has-background-grey-lighter">
                <h3 class="subtitle is-5 has-text-centered">Primary Models</h3>
                <div class="columns is-multiline">
                    ...
                    <div class="column is-full">
                        <model-item
                            title="Notification"
                            v-bind:fields="notificationModel"
                        ></model-item>
                    </div>
                    <div class="column is-full">
                        <model-item
                ...
                <h3 class="subtitle is-5 has-text-centered">Relation Models</h3>
                <div class="columns is-multiline">
                    <div class="column is-full">
                        <model-item
                            title="Announcement_Tag"
                            v-bind:fields="announcementTagModel"
                        ></model-item>
                    </div>
                    <div class="column is-full">
                        <model-item
                            title="Tag_User"
                            v-bind:fields="tagUserModel"
                        ></model-item>
                    </div>
                </div>
            </div>
...
export default {
    data: function() {
        return {
            tagModel: {
                id: "bigint(20) auto_increment p_key",
                title: "varchar(255)",
                is_public: "tinyint(1)",
            ...
            tagUserModel: {
                user_id: "bigint(20) p_key f_key",
                tag_id: "bigint(20) p_key f_key"
            },
            announcementModel: {
                id: "bigint(20) auto_increment p_key",
                title: "varchar(255)",
                ...
                user_id: "bigint(20) auto_increment f_key"
            },
            announcementTagModel: {
                announcement_id: "bigint(20) p_key f_key",
                tag_id: "bigint(20) p_key f_key"
            },
            attachmentModel: {
                id: "bigint(20) auto_increment p_key",
                announcement_id: "bigint(20) f_key",
            ...
            userSubscriptionsResponse: `[{"id":11,"title":"\u03a0\u03c1\u03b1\u03ba\u03c4\u03b9\u03ba\u03ae \u03ac\u03c3\u03ba\u03b7\u03c3\u03b7","parent_id":1,"is_public":false,"created_at":"2020-05-11 21:15:15","updated_at":"2020-05-11 21:15:15","deleted_at":null,"pivot":{"user_id":173,"tag_id":11}},{"id":12,"title":"\u03a0\u03c4\u03c5\u03c7\u03b9\u03b1\u03ba\u03ad\u03c2 \u0395\u03c1\u03b3\u03b1\u03c3\u03af\u03b5\u03c2","parent_id":1,"is_public":false,"created_at":"2020-05-11 21:15:15","updated_at":"2020-10-04 20:15:53","deleted_at":null,"pivot":{"user_id":173,"tag_id":12}},{"id":13,"title":"\u03a0\u03b1\u03c1\u03bf\u03c5\u03c3\u03b9\u03ac\u03c3\u03b5\u03b9\u03c2 \u03c0\u03c4\u03c5\u03c7\u03b9\u03b1\u03ba\u03ce\u03bd","parent_id":1,"is_public":false,"created_at":"2020-05-11 21:15:15","updated_at":"2020-05-11 21:15:15","deleted_at":null,"pivot":{"user_id":173,"tag_id":13}},{"id":15,"title":"\u039d\u03ad\u03b1 \u03c4\u03bc\u03ae\u03bc\u03b1\u03c4\u03bf\u03c2","parent_id":1,"is_public":true,"created_at":"2020-05-11 21:15:15","updated_at":"2020-05-11 21:15:15","deleted_at":null,"pivot":{"user_id":173,"tag_id":15}},{"id":21,"title":"\u0391\u03bd\u03b1\u03ba\u03bf\u03b9\u03bd\u03ce\u03c3\u03b5\u03b9\u03c2 \u03b3\u03c1\u03b1\u03bc\u03bc\u03b1\u03c4\u03b5\u03af\u03b1\u03c2","parent_id":1,"is_public":true,"created_at":"2020-05-11 21:15:15","updated_at":"2020-05-11 21:15:15","deleted_at":null,"pivot":{"user_id":173,"tag_id":21}},{"id":22,"title":"\u0395\u03ba\u03b4\u03b7\u03bb\u03ce\u03c3\u03b5\u03b9\u03c2","parent_id":1,"is_public":true,"created_at":"2020-05-11 21:15:15","updated_at":"2020-05-11 21:15:15","deleted_at":null,"pivot":{"user_id":173,"tag_id":22}},{"id":159,"title":"\u03a0\u03c4\u03c5\u03c7\u03b9\u03b1\u03ba\u03ae\/\u0394\u03b9\u03c0\u03bb\u03c9\u03bc\u03b1\u03c4\u03b9\u03ba\u03ae \u0395\u03c1\u03b3\u03b1\u03c3\u03af\u03b1","parent_id":1,"is_public":false,"created_at":"2021-03-30 16:45:13","updated_at":"2021-03-30 16:45:13","deleted_at":null,"pivot":{"user_id":173,"tag_id":159}}]`,
